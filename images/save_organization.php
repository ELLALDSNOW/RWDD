...
if ($org_id === null) {
    // Insert new organization; set created_by = current user
    ...
    // Add organization_user row with owner role
    ...
    // Update existing org: check membership/permissions first
    // allow update if user is owner or member (you can restrict to owner only)
    ...
    if ($res === false) {
        ...
        // fallback case: still allow for simplicity
    } else {
